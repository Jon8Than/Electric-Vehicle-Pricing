...
arrange(-mean) %>%
  head()
```
We collect the metrics of our regression tune and look at the mean
...
(I will recall the predictions, accuracy, and graphs for comparison. Whichever has the best accuracy is the one I will chose is best for my model)

Compared with rmse models and then pick the best rmse or I can just compare the accuracies?
